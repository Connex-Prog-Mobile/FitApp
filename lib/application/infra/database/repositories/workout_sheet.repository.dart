...
class WorkoutSheetRepository {
  ...
  Future<List<Map<String, dynamic>>> getWorkoutSheetsByUserId(
      int userId) async {
    return await db
        .query('workout_sheets', where: 'user_id = ?', whereArgs: [userId]);
  }

  Future<int> updateWorkoutSheet(
      int id, Map<String, dynamic> workoutSheet) async {
    return await db.update('workout_sheets', workoutSheet,
